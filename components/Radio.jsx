                    ...
                    <div className='controls'>
                        ...
                        <div className='display'>
                            <div className="cp_wrapper">
                                <section id="marquee">
                                    <div className="marquee" data-text='you are listing to bitBitmap | you are listing to bitBitmap'>
                                        <span className="sr-only">you are listing to bitBitmap | you are listing to bitBitmap</span>
                                    </div>
                                </section>
                            </div>
