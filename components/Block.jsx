...
export default function Block(props) {
  ...
  if (props.selected && !props.uploaded) {
    ...
    if (props.ipfs_cid) {
      return (
        <Link
          ...
          className="bg-[#ff8a001a] drop-shadow-lg w-100 h-[35px] shadow-black rounded hover:underline text-sm text-white flex justify-center items-center font-semibold cursor-pointer hover:drop-shadow-2xl transition-all ease-out"
        >
          {props.blockNumber}
          {/* <FaRegPlayCircle
            onClick={(e) => props.cancelBlock(props.index)}
      ...
      return (
        <div className="bg-[#ff8a001a] drop-shadow-lg w-100 h-[35px] shadow-black rounded text-sm text-white flex justify-center items-center font-semibold cursor-pointer hover:drop-shadow-2xl transition-all ease-out">
          {props.blockNumber}
        </div>
      );
    }
    ...
    return (
      <div className="bg-[#ff8a001a] group drop-shadow-lg w-100 h-[35px] shadow-black rounded text-sm text-white flex justify-center items-center font-semibold cursor-pointer hover:drop-shadow-2xl hover:bg-[#ffa500cf] transition-all ease-out relative">
        <FaCloudUploadAlt
    ...
    return (
      <div
        ...
        className="bg-[#ff6a0052] drop-shadow-lg w-100 h-[35px] shadow-black rounded text-sm text-white flex justify-center items-center font-semibold cursor-pointer hover:drop-shadow-2xl hover:bg-[#ffa500cf] transition-all ease-out"
      >
        {props.blockNumber}
      </div>
    );
